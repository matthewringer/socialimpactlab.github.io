...
# {% include icons/prototyping %} <span class="magenta">Idea to Prototype</span>
...
# {% include icons/management %} <span class="magenta">Technology Adoption Management</span>
...
# {% include icons/documentation %} <span class="magenta">Feedback Loops, Monitoring & Evaluation, Documentation</span>
...
# {% include icons/analysis %} <span class="magenta">Policy and Systems Analysis</span>
...
# {% include icons/subscription %} <span class="magenta">Technology Coordination Subscription</span>
